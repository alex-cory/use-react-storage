...
function useLocalStorage(keyOrObj, defaultVal) {
    ...
    const updateStorageObj = react_1.useCallback(() => setStorageObj(parseStorage(localStorage)), [setStorageObj, parseStorage]);
